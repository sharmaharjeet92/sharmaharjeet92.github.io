...
Since this post is getting bit longer and may be by now you might have already checked your mobile or hover to other tab. :) With that being said,I will leave few references which might help you in case, you want to dig deeper into this. 
...
In next article,we will discuss how to dump zone data automatically and then taking over the domain automatically once a dangling record is found. 
